...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_TERRIFY = 313,
    ABILITY_FRICE = 314,
    ABILITY_PARASITIC = 315,
    ABILITY_MINDFUL = 316,
    ABILITY_GROUNDED = 317,
    ABILITY_HYPNOTIC = 318,
    ABILITY_RADIANT = 319,
    ABILITY_REBORN = 320,
    ABILITY_INSIDIOUS = 321,
    ABILITY_ULTIMATE_HEAT = 322,
    ABILITY_RESTFUL = 323,
    ABILITY_VENOM_HEAL = 324,
    ABILITY_REAPER = 325,
    ABILITY_RESONANCE = 326,
    ABILITY_SAND_SPIRIT = 327,
    ABILITIES_COUNT_NEW,

...
enum __attribute__((packed)) Ability
{
    ...
    //New
    ABILITY_RENDING_TIDE = ABILITIES_COUNT_GEN9,
    ABILITY_GRUDGE = 312,
    ABILITY_FRICE = 313,
    ABILITY_PARASITIC = 314,
    ABILITY_MINDFUL = 315,
    ABILITY_GROUNDED = 316,
    ABILITY_HYPNOTIC = 317,
    ABILITY_RADIANT = 318,
    ABILITY_REBORN = 319,
    ABILITY_INSIDIOUS = 320,
    ABILITY_ULTIMATE_HEAT = 321,
    ABILITY_RESTFUL = 322,
    ABILITY_VENOM_HEAL = 323,
    ABILITY_REAPER = 324,
    ABILITY_RESONANCE = 325,
    ABILITY_SAND_SPIRIT = 326,
    ABILITY_OLD_STEEL = 327,
    ABILITY_DREAMER = 328,
    ABILITIES_COUNT_NEW,
    ABILITIES_COUNT = ABILITIES_COUNT_NEW,
};

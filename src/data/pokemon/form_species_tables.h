...
static const u16 sGulpinFormSpeciesIdTable[] = {
    SPECIES_GULPIN,
...
static const u16 sValvorinFormSpeciesIdTable[] = {
    SPECIES_VALVORIN,
    SPECIES_VALVORIN_NORMAL,
    SPECIES_VALVORIN_FIGHTING,
    SPECIES_VALVORIN_FLYING,
    SPECIES_VALVORIN_GROUND,
    SPECIES_VALVORIN_ROCK,
    SPECIES_VALVORIN_BUG,
    SPECIES_VALVORIN_GHOST,
    SPECIES_VALVORIN_STEEL,
    SPECIES_VALVORIN_FIRE,
    SPECIES_VALVORIN_WATER,
    SPECIES_VALVORIN_GRASS,
    SPECIES_VALVORIN_ELECTRIC,
    SPECIES_VALVORIN_PSYCHIC,
    SPECIES_VALVORIN_ICE,
    SPECIES_VALVORIN_DRAGON,
    SPECIES_VALVORIN_DARK,
    SPECIES_VALVORIN_FAIRY,
    FORM_SPECIES_END,
};

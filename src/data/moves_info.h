...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_BLAZE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A critically damaging\n"
            "kick. May cause a burn."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_IRON_HEAD] =
    {
        .name = COMPOUND_STRING("Iron Slam"),
        .description = COMPOUND_STRING(
            "Slams the foe with metal.\n"
            "May lower Defense."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_STEEL,
    ...
    [MOVE_GULP] =
    {
        .name = COMPOUND_STRING("Gulp"),
        .description = COMPOUND_STRING(
            "An attack that gulps half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB_GULP,
        .power = 30,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 25,
    ...
    [MOVE_MEGA_GULP] =
    {
        .name = COMPOUND_STRING("Mega Gulp"),
        .description = COMPOUND_STRING(
            "An attack that gulps half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB_GULP,
    ...
    [MOVE_GIGA_GULP] =
    {
        .name = COMPOUND_STRING("Giga Gulp"),
        .description = COMPOUND_STRING(
            "An attack that gulps half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB_GULP,
    ...
    [MOVE_TERA_GULP] =
    {
        .name = COMPOUND_STRING("Tera Gulp"),
        .description = COMPOUND_STRING(
            "An attack that gulps half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB_GULP,
    ...
    [MOVE_HYPER_LICK] =
    {
        .name = COMPOUND_STRING("Hyper Lick"),
        .description = COMPOUND_STRING(
            "Licks with a long tongue to\n"
            "absorb energy."),
        .effect = EFFECT_ABSORB_LICK,
        .power = 50,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SUPER_LICK] =
    {
        .name = COMPOUND_STRING("Super Lick"),
        .description = COMPOUND_STRING(
            "Licks with a long tongue to\n"
            "absorb energy."),
        .effect = EFFECT_ABSORB_LICK,
